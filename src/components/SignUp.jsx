...
export default class SignUp extends Component {
  ...
  async handleEmailValidation(e) {
    ...
    await api.validateEmail({ Email: this.state.email }).then(
      (res) => {
  ...
  async handleUsernameValidation(e) {
    ...
    await api.validateUsername({ UserName: this.state.username }).then(
      (res) => {
        ...
        .then((res) => {
          this.setState(
            ...
            () =>
              console.log(
                "email",
                res.data.invalidEmail,
                "username",
                res.data.invalidUsername
              )
          );
            ...
            <Form hasValidation onSubmit={(e) => this.handleSubmit(e)}>
              ...
              <div className="flex-col">
                <Button
                  variant="success"
                  size="md"
                  style={{ marginTop: "10px", fontWeight: "600", width: "50%" }}
                  type="submit"
                >
                  Sign Up
                </Button>
