...
class Flight extends React.Component {
  ...
  async handleSave() {
    ...
    await api
      .updateFlightbyId(this.state.id, flight)
      .then(window.location.reload());
  }
  async handleDelete() {
    await api.deleteFlightById(this.state.id).then(window.location.reload());
