...
export default class AdminPage extends Component {
  ...
  async handleAddFlight() {
    ...
    try {
      const res = await api.insertFlight(flight);
      console.log(res.data.data);
  
      this.setState((prevState) => ({
        flightArr: [...prevState.flightArr, res.data.data],
        filteredArr: [...prevState.filteredArr, res.data.data],
      ...
      this.setState({
        errMsg: "An error occurred while adding the flight. Please try again.",
      });
    }
  }
